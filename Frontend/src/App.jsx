...
import QuizCreation from './pages/Tutor/QuizCreation'
  ...
  return (
    <Routes>
      ...
      {/* Tutor routes */}
        ...
        <Route path="/tutor/analytics/:quizId" element={<QuizAnalytics />} />
        <Route path="/tutor/quizCreate/:quizId" element={<QuizCreator />} />
